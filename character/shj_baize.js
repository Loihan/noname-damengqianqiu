// 神器边框 UI 已抽离至 effect/shj_baize.js
import { baizeUI } from '../effect/shj_baize.js';
...
export default {
    ...
    skills: {
        ...
        // === 神器边框特效（实现见 effect/shj_baize.js） ===
        shj_baize_ui: baizeUI,
    },
    skillTranslate: {
        shj_zhaorui: "昭瑞",
        ...
        shj_pixie: "辟邪",
        shj_pixie_info: "出牌阶段限一次，若“祥瑞”标记数为：<br>奇数：你可以对至多X名角色各造成一点雷电伤害；<br>偶数：你可以横置并翻面至多X名未横置角色并各弃置其一张牌。<br>（X为“祥瑞”标记数且不大于5）",
        shj_lingyou: "灵佑",
