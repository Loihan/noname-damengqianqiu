export default {
    ...
    skillTranslate: {
        shj_zhaorui: "昭瑞",
        shj_zhaorui_info: "持恒技，锁定技，①每当你受到或造成的伤害结算后，或你的准备阶段时你获得一个“祥瑞”标记，然后若洞虚：未觉醒：你从游戏外获得一张白泽图未记录的非装备牌（无花色点数）；已觉醒：你摸一张牌。②你不能成为延时性囊牌的目标。",
        shj_tuna:"图纳",
        ...
        shj_lingyou: "灵佑",
        shj_lingyou_info: "持恒技，出牌阶段，你可以移除5个“祥瑞”标记并摸5张牌。",
        shj_dongxu: "洞虚",
        shj_dongxu_info: "持恒技，觉醒技，当你获得未记录的非装备牌后，白泽图记录其牌名。当你已记录所有非装备牌名时，你获得技能【镇厄】。",
        shj_zhen_e: "镇厄",
