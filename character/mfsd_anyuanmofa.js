...
// === 1. 鬼噬 (最终修正版：修复报错、初始化计数、回归结算) ===
    ...
    skillTranslate: {
        mfsd_guishi: "鬼噬",
        mfsd_guishi_info: "锁定技，你死亡时，将一张【桃】移出游戏，然后防止死亡，改为将你移出游戏。你的上家回合结束时将你移回游戏，然后你增加1点体力上限并回满体力。",
        mfsd_zhouyv: "咒域",
        mfsd_zhouyv_info: "锁定技，准备阶段，你横置任意名角色并获得其一张牌，然后你摸X张牌（X为你已损失体力值+1）。",
        mfsd_jiangming: "降冥",
        mfsd_jiangming_info: "当你造成伤害时，可令此伤害+1且改为火焰伤害，并令目标获得一个“降冥”标记。你的出牌阶段结束时，所有拥有“降冥”标记的角色回复等同于其“降冥”标记数的体力并移除该标记。",
        mfsd_xiongtun: "凶吞",
