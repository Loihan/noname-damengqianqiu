...
skillTranslate: {
    shj_huiyan: "秽宴",
    shj_huiyan_info: "持恒技，你的准备阶段，你令至多等同于你体力值的角色各获得一个“秽债”标记。当有“秽债”标记的其他角色受到伤害时，你获得其一张手牌。",
    shj_mingzhai: "溟债",
    shj_mingzhai_info: "持恒技，结束阶段，你获得所有有“秽债”标记的其他角色的一张牌；其他角色对你造成伤害时，其获得等量“秽债”标记；有“秽债”标记的其他角色的手牌上限-X，你的手牌上限+Y（X为其“秽债”标记数的一半，向上取整，Y为你的“秽债”标记数）。",
    shj_qishou: "契狩",
    shj_qishou_info: "当持恒技，你对有“秽债”标记的角色造成伤害时，你可以移除其一个“秽债”标记，令此伤害+1；当有“秽债”标记的角色失去最后一张手牌时，你可以移除其所有“秽债”标记，并对其造成等量点伤害。",
    shj_jiumo: "九殁",
    shj_jiumo_info: "持恒技，①当你于回合外失去手牌时，你摸一张牌；<br>②当你进入濒死状态时，若你的体力上限大于1，你弃置等同于体力上限张牌（不足则全弃），并记录弃牌量为X，然后减少一点体力上限，回复体力至X。然后，你可以选择至多X名有“秽债”标记的角色，令其选择一项（需满足括号内的条件才能选择对应选项，若都不满足则无需选择）：<br>1.减少一点体力上限（体力上限不为1）；<br>2.调整体力为1（体力值不为1）；<br>3.弃置所有手牌（手牌数≥3）。",
}, 
characterTaici:{
