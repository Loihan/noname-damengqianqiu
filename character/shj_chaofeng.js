// 嘲风·【弧形星环阵列】UI 已抽离至 effect/shj_chaofeng.js
import { chaofengUI } from '../effect/shj_chaofeng.js';
...
export default {
    character: {
        ...
        shj_chaofeng: {
            ...
            group:"shen", 
            hp:7, 
            skills:["shj_jingyue","shj_tingzong", "shj_lieying","shj_pini", "shj_weilin","shj_chaofeng_ui"], 
            img:"extension/大梦千秋/image/shj_chaofeng.jpg",
            dieAudios:["ext:大梦千秋/audio/shj_chaofeng/die.mp3"],
            names:"愿照|嘲风",
            groupInGuozhan:"ye",
            4:["des:嘲风，龙生九子之一，性好险，又好望，常立于殿台角上。其形威严，不仅象征着吉祥、美观和威严，而且还具有威慑妖魔、清除灾祸的含义，是祥瑞的象征。",]
        },
    },
    characterName: 'shj_chaofeng',
    characterTranslate: {shj_chaofeng: "嘲风",},
    skills: {
        //====================================
        //            初始技能                     
        //====================================
        ...
        shj_jingyue: {
            ...
            filterCard(card, player, event) {
                ...
                //AI决策
                var thisUsable = game.hasPlayer(function(cur){
                    return cur != player && get.distance(player, cur) <= player.getAttackRange();
                }) > 0;
                if (!player.isMine() && thisUsable){
                    //回合内优先出红
        ...
        shj_lieying: {
            ...
            filter: function(event, player) {
                ...
                if (!player.isMine() && hasRed) return false;
