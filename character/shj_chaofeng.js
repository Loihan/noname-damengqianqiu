...
skillTranslate: {
    shj_jingyue: "惊跃",
    shj_jingyue_info: "持恒技，你可以将一张：红色牌视为【火杀】使用或打出；黑色牌视为【雷杀】使用（每回合限一次，无距离限制，伤害+1且不可被响应）。<br>你每以此法使用一张牌：你摸一张牌，本回合内你的【杀】使用次数+1且攻击范围+1。<br>你每依此法造成一次伤害：你回复一点体力并获得一个“威”标记。",
    shj_tingzong: "霆踪",
