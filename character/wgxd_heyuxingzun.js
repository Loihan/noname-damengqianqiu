...
/////////////////////////////////////////////////////////////////////////////////
    ...
    skillTranslate: {
        wgxd_jianzhen: '剑阵',
        wgxd_jianzhen_info: '持恒技，锁定技，①游戏开始时，你拥有7个武器栏，废除你的所有非武器装备栏。②当你获得非武器装备牌时立即重铸之。',
        // === 修改点: 将 "减1点" 改为 "减3点" ===
        wgxd_qixia: '启匣',
        wgxd_qixia_info: '持恒技，锁定技，①游戏开始时，你在手牌里开辟出一个初始上限为1的区域。称之为“剑匣”，你将一张初始手牌加入“剑匣”。②当“剑匣”里的牌即将离开“剑匣”时立即摸等量的牌加入将“剑匣”。③“剑匣”里的牌无次数限制。④当你受到伤害时，若“剑匣”的上限小于7，则你摸一张牌、“剑匣”上限+1，你选择一张手牌加入“剑匣”。',
        wgxd_qixia_jian: '剑',
        wgxd_jianyun: '剑陨',
        wgxd_jianyun_info: '持恒技，①当你成为伤害性牌的目标时，你可以随机获得一张武器牌并立即使用之。②当你使用含“剑”字的牌时，你获得一张游戏外的无花色点数且不计入手牌上限的“万箭齐发”并在此回合结束后获得一个额外回合。',
        //wgxd_hemeng: '鹤梦',
