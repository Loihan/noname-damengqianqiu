...
skillTranslate: {
    shj_lianshi: "炼石",
    shj_lianshi_info: "持恒技，锁定技，①你的初始手牌数为全场人数（至少4张），并将这些牌标记为“五色石”。②“五色石”不计入手牌上限且不能在弃牌阶段棄置。当你失去“五色石”后，若你手牌中的“五色石”不包含所有花色，则你从牌堆中获得缺失的花色的牌各一张。③若你的“五色石”均在你的手牌当中，你使用牌无次数和距离限制。⑤准备阶段，你回收弃牌堆中所有的“五色石”。⑥当你成为延时锦囊牌的目标时，你跳过下个判定阶段。",
    "wuseshi": "五色石",
    shj_xirang: "息壤",
    shj_xirang_info: "持恒技，锁定技，当你使用或打出牌时记录此牌点数。当一名角色使用或打出已被你记录点数的牌时，若点数：<br>0~4:该角色下次受到的伤害+1；<br>5~9:你摸一张牌；<br>10~K:其弃置点数之和不小于此点数的牌；",
    shj_shenen: "神恩",
    shj_shenen_info: "持恒技，锁定技。当你对造成/受到伤害后，你回复/失去X点体力。（X为你已损失体力值的1/5，向下取整）",
    shj_guiyuan: "归元",
    shj_guiyuan_info: "持恒技，锁定技，每当有基本牌或普通锦囊牌进入弃牌堆时，你获得等量“元”标记。当的“元”标记数不小于X时（X为【息壤】未记录的点数的数量且至少为1），你移去X枚“元”标记并减少X点体力上限。",
    shj_tianhen: "天恨",
    shj_tianhen_info: "持恒技，锁定技，当你使用或打出牌时记录此牌牌名；当你记录了9种不同的牌名后，你减少9点体力上限并然后清空所有记录。",
    shj_butian: "补天",
    shj_butian_info: "持恒技，觉醒技，当你的体力等于体力上限时，你令任意名其他角色立即死亡，然后将你的体力上限变为1。",
    },
};