...
shj_lianshi: {
    ...
    subSkill: {
        draw:{
            ...
            content: function() {
                var targetNum = 12 - game.countPlayer();
...
skillTranslate: {
    shj_lianshi: "炼石",
    shj_lianshi_info: "锁定技，①所有角色的初始手牌数改为12-X（X为全场人数），并将你的初始手牌标记为“五色石”。第一轮开始时你将手牌摸至等同于全场人数。②“五色石”不计入手牌上限且不能在弃牌阶段弃置。当你失去“五色石”后，若你手牌中的“五色石”不包含所有花色，则你从牌堆中获得缺少的花色的牌各一张。③若你的“五色石”均在你的手牌当中，你使用牌无次数和距离限制。⑤准备阶段，你回收弃牌堆中所有的“五色石”。⑥当你成为延时锦囊牌的目标时，你跳过下个判定阶段。",
    "wuseshi": "五色石",
    shj_xirang: "息壤",
