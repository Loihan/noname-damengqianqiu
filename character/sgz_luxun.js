export default {
    character: {
        // 梦陆逊：梦势力，5体力
        sgz_luxun: ["male", "shen", 4, ["sgz_qujian", "sgz_lianying", "sgz_taohui", "sgz_fenmie"], [
    ...
    skillTranslate: {
        sgz_qujian: "驱剑", sgz_qujian_info: "持恒技，锁定技，连招技（杀+锦囊牌），出牌阶段限X次（X为你回合开始时的体力数），你摸Y张牌且本回合可以额外使用一张【杀】（Y为场上已横置的角色数）。",
        sgz_lianying: "连营", sgz_lianying_info: "持恒技，锁定技，①摸牌阶段，你多摸X张牌，手牌上限+X。②当你失去最后一张手牌时，你摸至X张牌。（X为场上人数）",
        sgz_taohui: "韬晦", sgz_taohui_info: "持恒技，每轮限一次，当你进入濒死状态时，你可以增加1点体力上限并回复至1点体力，然后重复亮出牌堆顶的一张牌并根据其花色执行对应效果直至被不可执行或你取消（♥️：你回复一点体力；♦️/♠️：视为使用一张无距离限制的火/雷【杀】；♣️：横置至多三名未横置角色）。",
        sgz_fenmie: "焚灭", sgz_fenmie_info: "持恒技，出牌阶段限一次。你可以选择任意名其他角色并摸等量的牌，然后重复以下流程：<br>①被选中的所有角色同时展示一张手牌；<br>②你可以弃置任意张相同花色的牌并对其中展示对应花色牌的角色各造成1点火焰伤害;<br>③若这些对应花色的角色均受到了伤害，则重复此流程，否则技能结束。<br>此技能结算期间每当你失去牌时便摸等量的牌。",
    },
    characterTaici: {
