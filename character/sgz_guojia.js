export default {
    ...
    skillTranslate: {
        ...
        sgz_jihui: "极慧",
        sgz_jihui_info: "出牌阶段限一次或当你受到伤害时（每回合限一次），若你的体力上限<10，你可进行判定，若未出现相同花色的判定牌且你的体力上限<10，则你增加一点体力上限并重复此流程。你获得所有以此法产生的判定牌。",
        sgz_tianshang: "天殇",
