export default {
    ...
    skillTranslate: {
        ...
        sgz_xuanhe: "璇和", 
        sgz_xuanhe_info: "持恒技，锁定技，当你使用锦囊牌时摸一张牌，此牌不计入手牌上限。然后你按照所使用的锦囊牌花色执行对应效果:<br>♦️：视为对其使用一张无次数距离限制的火【杀】；<br>♥️：若你已受伤则回复一点体力，否则获得一点护甲；<br>♠️：选择一名其他角色获得其一张牌；<br>♣️：本回合出【杀】次数+1（不可叠加），获得一张无色【闪】，标记为“梦闪”，不计入手牌上限。",
        sgz_changming: "长明", 
